...
from .weather_mcp import create_weather_search_mcp
from .web_search_mcp import create_web_search_mcp

# 映射服务名称到它们对应的工厂函数
AVAILABLE_MCPS = {
    "google_maps": create_google_route_mcp,
    "google_route": create_google_route_mcp, # 兼容老名称
    "weather_search": create_weather_search_mcp,
    "web_search": create_web_search_mcp,
